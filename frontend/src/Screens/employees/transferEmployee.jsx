...
function TransferEmployee() {
    ...
    const [employeeTrasnferHistroy, setEmployeeTrasnferHistroy] = useState();
    ...
    const runApi = () => {
        ...
        CallAPI("Employee/GetEmployeeTransferHistory?employeeId=" + employeeId).then(res => {
            setEmployeeTrasnferHistroy(res.map(r=>{
    ...
    const applyHandler = async () => {
        ...
        const res = await CallAPI('Employee/TransferEmployee', 'POST', payload);
    ...
    return (
        <>
            <Topbar title="Transfer Employee" />
            ...
            <div className="px-3">
                <div className="box floating-heading">
                    <h2 className="ps-2 mb-4 heading">Transfer Employee</h2>
            ...
            <Table isSmall noPagination title="Leaves History" data={employeeTrasnferHistroy} />
        </>
    );
}
